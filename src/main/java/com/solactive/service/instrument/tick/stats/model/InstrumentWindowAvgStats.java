...
@Component
public class InstrumentWindowAvgStats {

	// Mark final to make the constructs thread safe
	private final ConcurrentHashMap<String, Double> instrumentAvgLastWindow = new ConcurrentHashMap<String, Double>();
	...
	public ConcurrentHashMap<String, Double> getInstrumentAvgLastWindow() {
		return instrumentAvgLastWindow;
	}
