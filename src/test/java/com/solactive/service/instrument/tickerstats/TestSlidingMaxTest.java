...
import com.solactive.service.instrument.tick.stats.service.SlidingMaxTask;

@SpringBootTest
class TestSlidingMaxTest {
	...
	void testUpdateStats() {
		...
		InstrumentWindowMaxStats instrumentWindowMaxStats = new InstrumentWindowMaxStats();
		...
		SlidingMaxTask slidingMaxTask = new SlidingMaxTask(instrumentWindowMaxStats, currentTime.getMillis(), tick,
				windowSizeSec);
		slidingMaxTask.updateStats();
		assertEquals(instrumentWindowMaxStats.getInstrumentMaxLastWindow().get("instr1"), 12.5);
		...
		slidingMaxTask = new SlidingMaxTask(instrumentWindowMaxStats, currentTime.getMillis(), tick, windowSizeSec);
		slidingMaxTask.updateStats();
		assertEquals(instrumentWindowMaxStats.getInstrumentMaxLastWindow().get("instr1"), 15.5);
		...
		slidingMaxTask = new SlidingMaxTask(instrumentWindowMaxStats, currentTime.getMillis(), tick, windowSizeSec);
		slidingMaxTask.updateStats();
		assertEquals(instrumentWindowMaxStats.getInstrumentMaxLastWindow().get("instr1"), 13.5);
		...
		slidingMaxTask = new SlidingMaxTask(instrumentWindowMaxStats, currentTime.getMillis(), tick, windowSizeSec);
		slidingMaxTask.updateStats();
		assertEquals(instrumentWindowMaxStats.getInstrumentMaxLastWindow().get("instr1"), 60.5);
		...
		slidingMaxTask = new SlidingMaxTask(instrumentWindowMaxStats, currentTime.getMillis(), tick, windowSizeSec);
		slidingMaxTask.updateStats();
		assertEquals(instrumentWindowMaxStats.getInstrumentMaxLastWindow().get("instr1"), 23.2);
		...
		slidingMaxTask = new SlidingMaxTask(instrumentWindowMaxStats, currentTime.getMillis(), tick, windowSizeSec);
		slidingMaxTask.updateStats();
		assertEquals(instrumentWindowMaxStats.getInstrumentMaxLastWindow().get("instr1"), 26.4);
