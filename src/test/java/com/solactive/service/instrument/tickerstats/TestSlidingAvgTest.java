...
import com.solactive.service.instrument.tick.stats.service.SlidingAvgTask;

@SpringBootTest
class TestSlidingAvgTest {
	...
	void testUpdateStats() {
		...
		InstrumentWindowAvgStats instrumentWindowAvgStats = new InstrumentWindowAvgStats();
		...
		SlidingAvgTask slidingAvgTask = new SlidingAvgTask(instrumentWindowAvgStats, currentTime.getMillis(), tick,
				windowSizeSec);
		slidingAvgTask.updateStats();
		assertEquals(instrumentWindowAvgStats.getInstrumentAvgLastWindow().get("instr1"), 12.5);
		...
		slidingAvgTask = new SlidingAvgTask(instrumentWindowAvgStats, currentTime.getMillis(), tick, windowSizeSec);
		slidingAvgTask.updateStats();
		assertEquals(instrumentWindowAvgStats.getInstrumentAvgLastWindow().get("instr1"), 14);
		...
		slidingAvgTask = new SlidingAvgTask(instrumentWindowAvgStats, currentTime.getMillis(), tick, windowSizeSec);
		slidingAvgTask.updateStats();
		assertEquals(Precision.round(instrumentWindowAvgStats.getInstrumentAvgLastWindow().get("instr1"),2), 13.33);
		...
		slidingAvgTask = new SlidingAvgTask(instrumentWindowAvgStats, currentTime.getMillis(), tick, windowSizeSec);
		slidingAvgTask.updateStats();
		assertEquals(instrumentWindowAvgStats.getInstrumentAvgLastWindow().get("instr1"), 12);
		...
		slidingAvgTask = new SlidingAvgTask(instrumentWindowAvgStats, currentTime.getMillis(), tick, windowSizeSec);
		slidingAvgTask.updateStats();
		assertEquals(instrumentWindowAvgStats.getInstrumentAvgLastWindow().get("instr1"), 11);
		...
		slidingAvgTask = new SlidingAvgTask(instrumentWindowAvgStats, currentTime.getMillis(), tick, windowSizeSec);
		slidingAvgTask.updateStats();
		assertEquals(instrumentWindowAvgStats.getInstrumentAvgLastWindow().get("instr1"), 37);
		...
		slidingAvgTask = new SlidingAvgTask(instrumentWindowAvgStats, currentTime.getMillis(), tick, windowSizeSec);
		slidingAvgTask.updateStats();
		assertEquals(Precision.round(instrumentWindowAvgStats.getInstrumentAvgLastWindow().get("instr1"),2), 26.83);
		...
		slidingAvgTask = new SlidingAvgTask(instrumentWindowAvgStats, currentTime.getMillis(), tick, windowSizeSec);
		slidingAvgTask.updateStats();
		assertEquals(instrumentWindowAvgStats.getInstrumentAvgLastWindow().get("instr1"), 14.4);
		...
		slidingAvgTask = new SlidingAvgTask(instrumentWindowAvgStats, currentTime.getMillis(), tick, windowSizeSec);
		slidingAvgTask.updateStats();
		assertEquals(Precision.round(instrumentWindowAvgStats.getInstrumentAvgLastWindow().get("instr1"),2), 14.20);
		...
		slidingAvgTask = new SlidingAvgTask(instrumentWindowAvgStats, currentTime.getMillis(), tick, windowSizeSec);
		slidingAvgTask.updateStats();
		assertEquals(Precision.round(instrumentWindowAvgStats.getInstrumentAvgLastWindow().get("instr1"),2), 20.83);
